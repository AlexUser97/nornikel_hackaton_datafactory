...
Выдаёт маску в цветовой схеме ТЗ:
    ...
    2 — тальк             (синий):     тёмные текстурные области в нерудных зонах;
    3 — нерудный фон      (тёмный):    силикаты/матрица без талька.
...
ORE_PETRO_CLASS_NAMES = ["тонкие срастания", "обычные срастания", "тальк", "оксиды (магнетит)", "нерудный фон"]
